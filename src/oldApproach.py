...
# Hand Detection 
with mp_hands.Hands(
    min_detection_confidence = 0.7, # improves accuracy
    min_tracking_confidence = 0.4) as hands: # Setting sensitivity to improve latency
    while cap.isOpened():
